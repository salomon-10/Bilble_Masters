                ...
                <?php foreach ($trials as $trial): ?>
                    <div class="trial">
                        ...
                        <div class="trial-head">
                            ...
                            <div class="trial-badge">Ordre <?php echo $trialOrder; ?></div>
                        </div>
                        <div class="trial-body">
                            <form method="post" class="trial-form" data-trial-order="<?php echo $trialOrder; ?>">
                                <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars(csrfToken(), ENT_QUOTES, 'UTF-8'); ?>">
                                <input type="hidden" name="match_id" value="<?php echo (int) $matchId; ?>">
                                <input type="hidden" name="tournament_id" value="<?php echo (int) $tournamentId; ?>">
                                <input type="hidden" name="action" value="autosave_trial">
                                <input type="hidden" name="trial_order" value="<?php echo $trialOrder; ?>">
                                <div class="rows">
                                    <div class="row a">
